...
print(busTimeRideList) #배열 내용 확인
...
print(busTimeAlightList) #배열 내용 확인
...
print(subwayTimeRideList) #배열 내용 확인
...
print(subwayTimeAlightList) #배열 내용 확인
